...
class SelfdriveD(CruiseHelper):
  def __init__(self, CP=None, CP_SP=None):
    ...
    ignore = self.sensor_packets + self.gps_packets + ['alertDebug'] + ['modelDataV2SP'] + ['liveTorqueParameters', 'liveDelay', 'liveParameters', 'driverAssistance', 'liveCalibration', 'longitudinalPlan', 'radarState']  # NO-NAG PATCH: ignore warm-up flapping
    if SIMULATION:
